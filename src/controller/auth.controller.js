...
async function forgotLink(req, res) {
  try {
    ...
    const details = {
      ...
      text: "We have sent you this email in response to your request to reset your password on ${site-name}. After you reset your password, any credit card information stored in My Account will be deleted as a security measure.  To reset your password for ${site-url}, please follow the link below:  ${https://xeniaverse.co.in/resetpassword/${user._id}/${token}}   We recommend that you keep your password secure and not share it with anyone. If you feel your password has been compromised, you can change it by going to your My Account Page and clicking on the Change Email Address or Password link.",
